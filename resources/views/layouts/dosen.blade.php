...
@php
$navItems = [
    ['route' => 'dosen.dashboard', 'label' => 'Dashboard', 'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'],
    ['route' => 'dosen.otp-history', 'label' => 'Riwayat OTP', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
];
@endphp
            ...
            <div class="p-3 border-t border-neutral-content/10">
                <div class="flex items-center gap-3 px-3 py-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-neutral-content/40">Dosen</p>
                    </div>
